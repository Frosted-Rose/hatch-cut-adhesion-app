...
# =============================
# Main: File upload on center pane
# =============================
st.subheader("Upload Images")
uploaded_files = st.file_uploader(
    "Upload one or more hatch cut images (PNG/JPG)",
    type=["png", "jpg", "jpeg"],
...
if uploaded_files:
    ...
    st.info("Upload images above to enable coating color selection and analysis.")

# =============================
# Main Pipeline
# =============================
if uploaded_files and (coating_rgb is not None):
    results = []
    thumb_map = {}
    overlay_map = {}
